        ...
        this.startDrag = function (e) {
            ...
            $doc.on(
                ...
                .on(
                    ...
                    ,function (e) {
                        if(e.keyCode === 27) {
                            $doc.off("mouseup.dial mousemove.dial keyup.dial");
                            self.cancel();
                        }
                    }
                )
                .on(
                    ...
                    ,function (e) {
                        $doc.off('mousemove.dial touchmove.dial mouseup.dial touchend.dial keyup.dial');
                        self.val(self.val());
                        self.onRelease(v);
                    }
                );
        ...
        return this.each(
            ...
            function () {
                ...
                k.onChange = function (v) {
                						//console.debug("k.onChange");
                						console.dir($this);
                                            $this.val(v).trigger('change'); // trigger change event on input element to notify any other listeners
                                            opt.change(v);
                                         };
